...
export class IngressRuleFlatListComponent {
  ...
  ingressSpecRuleToIngressRuleFlat(namespace: string, ingressSpecRules: IngressSpecRule[]): IngressRuleFlat[] {
  ...
  getDataSource(): MatTableDataSource<IngressRuleFlat> {
    ...
    tableData.data = this.ingressSpecRuleToIngressRuleFlat(this.namespace, the_input);
